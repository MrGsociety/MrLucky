        ...
        private void register_btn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    connection.Open();      
                    string query = "INSERT INTO Mr_Lucky (`username`, `password`, `money`, `bank_money`, `lvllistener`, `creation_date`) VALUES('"+reg_namenome+"','"+reg_password+"','"+money.ToString()+"','"+bank_money.ToString()+"','"+lvllistener.ToString()+"','"+DateTime.Now.ToString()+"')";
